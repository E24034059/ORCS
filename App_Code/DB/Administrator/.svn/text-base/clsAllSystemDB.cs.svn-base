...
namespace AllSystemDB
{

    /// <summary>
    /// AllSystemDB 的摘要描述
    /// </summary>
    public class clsAllSystemDB
    {
        ...
        /// </summary>
        public clsAllSystemDB()
        {
            m_strConnection = System.Configuration.ConfigurationManager.ConnectionStrings["connAllSystemDB"].ToString();
        }
        ...
        public clsAllSystemDB(string connstr)
        {
